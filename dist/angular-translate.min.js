...
// Start with the fallbackLanguage with index 0
return ca(F>0?F:l,a,b,c)},fa=function(a,b,e,f,h){"undefined"==typeof c.translation_variables&&(c.translation_variables={}),a in c.translation_variables||(c.translation_variables[a]=!0);var i=d.defer(),j=h?u[h]:u,k=e?S[e]:G;
...
f?i.resolve(f):i.resolve(o):f?i.resolve(f):i.reject(V(a))}return i.promise},ga=function(a,b,d,e){"undefined"==typeof c.translation_variables&&(c.translation_variables={}),a in c.translation_variables||(c.translation_variables[a]=!0);var f,h=e?u[e]:u,i=G;
// if the translation id exists, we can just interpolate it
if(
